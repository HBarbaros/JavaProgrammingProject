...
public class WarmUpTasks {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(arr)) // toString method should use with ArraysUtility
         */
        ...
        System.out.println("total number of zero = " + totalNumberOfZero);
        ...
        letters.removeIf( p -> !Character.isLetter(p) ); // remove the characters which are not letters
        System.out.println("letters = " + letters);

        ArrayList<Character> digits = new ArrayList<>(chars); // add all the characters
        digits.removeIf( p -> !Character.isDigit(p)); // remove the characters which are not digits
