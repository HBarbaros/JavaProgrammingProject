...
public class BulkOperations {
    ...
    public static void main(String[] args) {
        ...
        list.addAll(Arrays.asList(1,2,3,4,5,6,7,8,3,3,3,3,3,5,5,5,5,8,8,8,8,8));
        System.out.println(list);

        list.removeAll(Arrays.asList(3,5,8)); // remove value of the just chosen. (remove 3,5,8)
        System.out.println(list);
        ...
        numbers.retainAll(Arrays.asList(100,200,300)); // remove all value without the number of chosen. (keep number 100,200,300)
